...
const chapters = [
  ...
  },
  {
    ...
    keyPoints: [
      ...
      'أنواع الأجراف: مائلة الانحدار (Slope-over-wall)، مستقيمة، ومرتدة (Overhang).',
    ],
  ...
  {
    num: '13',
    title: 'الأجراف الساحلية والمنحدرات',
    ...
    keyPoints: [
      ...
      'الأجراف الطباشيرية (كدوفر) أسرع تراجعاً من البازلتية لهشاشة الكربونات بالتحلل.',
